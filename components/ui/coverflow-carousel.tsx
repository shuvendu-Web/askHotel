    ...
    >
      <div className="relative">
        <div
          ...
          className="cursor-grab overflow-hidden pt-0 pb-12 outline-none ring-ring focus-visible:ring-2 active:cursor-grabbing"
          style={{
          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  "absolute left-1/2 top-0 aspect-[4/5] overflow-hidden rounded-2xl bg-muted shadow-[0_15px_40px_-5px_rgba(249,115,22,0.6)] will-change-transform",
                  cardClassName,
                )}
              ...
              >
                ...
                {slide.subtitle && (
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-black text-xs font-bold px-3 py-1.5 rounded-full shadow-lg z-20">
